...
public class UserService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username)
		...
		List<GrantedAuthority> authorities = buildAuthirities(user.getUserRole());
	...
	/**
	 * Builds the authirities.
	 *
	 * @param userRoles the user roles
	 * @return the list
	 */
	private List<GrantedAuthority> buildAuthirities (Set<UserRole> userRoles){
